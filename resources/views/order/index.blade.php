<x-layout>
    ...
    <div class="container">
        @if (session('success'))
            <div class="alert alert-success animate__animated animate__fadeIn animate__fast" role="alert">
                {{ session('success') }}
            </div>
        @endif
        ...
        <div class="card mb-2 overflow-hidden animate__animated animate__fadeIn animate__fast">
