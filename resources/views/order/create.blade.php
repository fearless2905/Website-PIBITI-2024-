        ...
        <div class="row">
            <div class="col">
                <div class="d-grid gap-4">
                    <form class="hstack gap-2 animate__animated animate__fadeIn animate__fast" method="get">
                    ...
                    <div class="row g-4">
                        @forelse ($products as $product)
                            <div class="col-3 animate__animated animate__fadeIn animate__fast">
                        ...
                        @empty
                            <div class="col text-center animate__animated animate__fadeIn animate__fast">Belum ada
                                products</div>
                        @endforelse
                    </div>
                </div>
